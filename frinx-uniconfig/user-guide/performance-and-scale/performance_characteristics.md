...
## Performance characteristics considering a single node of Uniconfig.
...
## Performance characteristics considering a 3 nodes of Uniconfig with load balancer.

Important caveats:
- Measurement were performed on simulated devices = no device overhead
- Measurement were performed on a local network = no network overhead
- Measured on Uniconfig version 5.0.12 - three replicas
- Per Uniconfig instance resources: a) CPU 4 cores and RAM 4 GB b) 6 cores and RAM 4 GB
...
## Performance characteristics considering 3 nodes of Uniconfig with load balancer.
