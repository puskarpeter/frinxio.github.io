...
![Reading CLI conf from device](Process-of-reading-of-CLI-configuration-from-device.png)
...
![Different scenarios](Reading-of-configuration-from-CLI-network-device-different-scenarios.png)
